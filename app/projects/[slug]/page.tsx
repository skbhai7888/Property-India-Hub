...
const PhoneIcon = ({size = 16, color = "white"}: {size?: number, color?: string}) => (
  <svg viewBox="0 0 24 24" width={size} height={size} fill={color}><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/></svg>
);
...
const projects: Record<string, any> = {
  ...
  'garh-ganga-enclave': {
    ...
    description: "Gated plotted township near holy Ganga river. Immediate registry & mutation available. 200m from NH-09 Delhi-Meerut corridor.",
  ...
  'sunshine-city-plots': {
    ...
    description: "NOC approved freehold plots just 15 min from Jewar International Airport. 70% bank loan available from PNB Housing Finance.",
  ...
  'scc-blossom': {
    ...
    description: "Triple RERA approved high-rise on Main NH-58. 400% historical ROI. Near Hindon Airport & Metro. Predicted ₹9000+ by 2028.",
  ...
  'dev-bhoomi-uttarakhand': {
    ...
    description: "Pre-launch hill plots near sacred Jageshwar Dham & Kasar Devi Temple. 5-star resort concept with 10-acre dense forest & Himalayan views.",
  ...
  'mapple-green': {
    ...
    description: "RERA & BIDA approved township on Delhi-Jaipur NH-48. 1 min from RRTS Sotanala Station. Shop booking starts at just ₹51,000.",
  ...
  'radha-krishna-vihar': {
    ...
    description: "Gated residential plots in divine Mathura. 1 KM from Sanskriti University. Easy 12-month EMI plan available.",
  ...
  'radha-krishna-puram': {
    ...
    mapLink: "https://maps.google.com/?q=Chhata+Mathura+UP",
    description: "Ready-to-build gated community in Mathura. In front of Shree Ji Baba Law College. EMI starting ₹90,000/month.",
    sizes: ["100 Sq.Yard (900 Sq.Ft)"],
  ...
  'radha-krishna-brij-bhumi': {
    ...
    description: "Most affordable plots in Mathura Brij region. Just 400m from Delhi-Agra Highway. Phase II & III available.",
  ...
  'radhe-awadh-puri': {
    ...
    description: "Gated plots in holy Ayodhya. 10 KM from Ram Mandir, 13 KM from Valmiki International Airport.",
    sizes: ["100 Sq.Yard (900 Sq.Ft)"],
  ...
  'radhe-shyam-puri': {
    ...
    description: "Premium plots near world-famous Khatu Shyam Ji Mandir. 7 KM from main temple, 300m from Karni Mata Mandir.",
    sizes: ["100 Sq.Yard (900 Sq.Ft)"],
  ...
  'shri-ram-janki-ayodhya-dham': {
    ...
    description: "Premium plots just 400m from upcoming Leela Ambience 7-Star Hotel. 8 KM from Ram Mandir. Fastest appreciating location in UP.",
    sizes: ["100 Sq.Yard (900 Sq.Ft)"],
    amenities: ["High Boundary Wall", "Security Lobby", "Wide Roads", "Park", "Sewage Line", "Street Lights"],
    highlights: ["400m from Leela 7-Star Hotel", "8 KM from Ram Mandir", "15 KM from Valmiki Airport"],
  ...
  'radha-krishna-nagar': {
    ...
    description: "Strategic plots near KMP Expressway. 700m from KMP, 2 KM from Dadri Railway Station. Near Hero Factory & Air Force Station.",
    sizes: ["100 Sq.Yard (900 Sq.Ft)"],
  ...
  'shree-govind-vatika': {
    ...
    description: "Most budget-friendly plots near Mathura Brij circuit. 18 KM from Govardhan Parbat. Perfect for long-term investment.",
    sizes: ["100 Sq.Yard (900 Sq.Ft)"],
  ...
  'radha-krishna-vrindavan-ashram': {
    ...
    description: "Premium plots near Vrindavan's holiest temples. 6 KM from Prem Mandir, 7 KM from ISKCON, 8 KM from Banke Bihari.",
    sizes: ["100 Sq.Yard (900 Sq.Ft)"],
  ...
  'shree-radha-krishna-enclave': {
    ...
    description: "Strategic plots connecting Mathura & Jewar Airport. 20 KM from Jewar International Airport & 6 KM from Bajna Industrial Area.",
    sizes: ["100 Sq.Yard (900 Sq.Ft)"],
  ...
  'shree-radha-krishna-vatika': {
    ...
    description: "Prime plots just 8 KM from Jewar International Airport. Fastest growing corridor post airport announcement.",
    sizes: ["100 Sq.Yard (900 Sq.Ft)"],
  ...
  'prateek-grand-begonia': {
    ...
    description: "Ultra-luxury 32-floor towers in 40-acre integrated township. Golf cart, rooftop garden, EV charging at every parking. 2 min from Metro & RRTS.",
      ...
      <div className="max-w-4xl mx-auto p-4">
        ...
        <a href={project.mapLink} target="_blank" className="flex items-center gap-3 bg-white rounded-xl shadow p-4 mb-4 border-l-4" style={{borderColor: '#4285F4'}}>
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">{project.location} — Tap to open location</p>
          </div>
        ...
        <div className="grid grid-cols-3 gap-3 mb-4">
          <a href={`https://wa.me/917820008509?text=I am interested in ${project.name}, ${project.location}. Please share details.`} className="flex items-center justify-center gap-1 text-white text-center py-3 rounded-xl font-bold text-xs" style={{background: '#25D366'}}>
            <WhatsAppIcon size={14} /> WhatsApp
          </a>
          <a href="tel:+917820008509" className="flex items-center justify-center gap-1 text-white text-center py-3 rounded-xl font-bold text-xs" style={{background: '#0a1628'}}>
            <PhoneIcon size={14} /> Call
          </a>
          <button onClick={handleShare} className="flex items-center justify-center gap-1 text-black text-center py-3 rounded-xl font-bold text-xs" style={{background: '#c9a84c'}}>
            <ShareIcon size={14} /> Share
          </button>
        </div>
        ...
        <div className="bg-white rounded-xl shadow p-4 mb-6">
          ...
          {form.submitted ? (
            ...
            <div className="flex flex-col gap-3">
              ...
              <button onClick={handleSubmit} className="w-full py-3 rounded-xl font-bold text-white mt-2 text-sm" style={{background: '#0a1628'}}>
                Submit Inquiry 🚀
              </button>
            </div>
          )}
